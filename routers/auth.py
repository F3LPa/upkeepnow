...
from auth.payloads.login_user import LoginUserResponse
from auth.user_token import create_access_token, user_authenticate
from conf.db_session import create_session, Session
from models.funcionario import Funcionario
from logger import logger
from conf.security import hash_password, verify_password
...
async def login(request: Annotated[OAuth2PasswordRequestForm, Depends()], db: Session = Depends(create_session)):
    try:
