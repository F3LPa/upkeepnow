...
class Atividade(Base):
    ...
    tipo_manutencao: str = Column(sa.Enum('corretiva', 'preditiva', 'preventiva'), nullable=False)
    ...
    funcionario_criador: str = Column(sa.String(50), sa.ForeignKey('funcionarios.cpf'), nullable=False)
