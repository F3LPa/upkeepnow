...
class Atividade(Base):
    ...
    tipo_manutencao: str = Column(
        sa.Enum("corretiva", "preditiva", "preventiva", name="tipo_manutencao_enum"),
        nullable=False,
    )
    ...
    descricao: Optional[str] = Column(sa.Text)
    ...
    def __repr__(self):
        return (
            f"<Atividade(ordem_servico={self.ordem_servico}, "
            f"nome='{self.nome}', tipo='{self.tipo_manutencao}')>"
        )
