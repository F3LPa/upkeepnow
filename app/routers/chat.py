...
def send_message(chat_id: str, request: MessageRequest, user_doc: dict = Depends(get_current_user)):
...
def edit_message(chat_id: str, mensagem_id: str, request: MessageRequest, user_doc: dict = Depends(get_current_user)):
...
def delete_message(chat_id: str, mensagem_id: str, user_doc: dict = Depends(get_current_user)):
