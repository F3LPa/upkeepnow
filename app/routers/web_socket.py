    ...
    try:
        while True:
            ...
            if event_type == "new_message":
                ...
                if "enviado_em" in saved_message and isinstance(saved_message["enviado_em"], datetime):
                    saved_message["enviado_em"] = saved_message["enviado_em"].isoformat()
                ...
                try:
                    # Atualiza no banco
                    chat_service.update_message(chat_id, message_id, user_doc, new_content)
                ...
                try:
                    deleted_message_data = chat_service.delete_message(chat_id, message_id, user_doc)
